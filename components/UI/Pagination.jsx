...
export const Pagination = ({ pageNum, handler, total }) => {
  ...
  return (
    <div className="pagination">
      {pageNum !== 1 && (
        <div
          className="pagination__arrow-wrapper"
        ...
        {paginationArray.map((item) =>
          item !== "..." ? (
            <div
              ...
              className={
                "pagination__item text_type_main" +
                (pageNum === item ? " pagination__item_active" : "")
              }
            >
              {item}
            </div>
          ) : (
            <div key={item} className="pagination__more-item text_type_main">
              ...
            </div>
          )
        )}
